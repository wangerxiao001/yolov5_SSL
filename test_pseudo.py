...
def test(data,
    ...
    if save_json and len(jdict):
        ...
        anno_json = '/home/ubuntu/wangxinglie/datasets/images17/annotations/instances_test2020.json'  # annotations json
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            print('[info] eval custom datasets!')
            ...
            # edited by wang
                ...
                eval.params.imgIds = processed_image_ids  # image IDs to evaluate
            eval.evaluate()
            eval.accumulate()
            eval.summarize()
